...
public readonly struct AttackData 
{
    ...
    /// </remarks>
    public int XPDamage { get; }
    /// <summary>
    /// Transform of entity that can push player 
    /// </summary>
    public Transform AttackerTransform { get; }
    public float PushSpeed { get; }
    public AttackData(float damage, DamageType damageType = DamageType.Physical, int xpDamage = 0, Transform transform = null, float pushSpeed = 0f)
    {
        Damage = damage;
